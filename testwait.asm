...
main(int argc, char *argv[])
{
  ...
  25:	e8 c6 06 00 00       	call   6f0 <malloc>
  ...
  8c:	58                   	pop    %eax
  8d:	5a                   	pop    %edx
  8e:	68 f4 07 00 00       	push   $0x7f4
  93:	6a 01                	push   $0x1
  95:	e8 f6 03 00 00       	call   490 <printf>
    wait(status);
  ...
  b3:	59                   	pop    %ecx
  b4:	58                   	pop    %eax
  b5:	68 1e 08 00 00       	push   $0x81e
  ba:	6a 01                	push   $0x1
  bc:	e8 cf 03 00 00       	call   490 <printf>
    wait(status);
  ...
  cc:	ff 33                	pushl  (%ebx)
  ce:	68 0c 08 00 00       	push   $0x80c
  d3:	6a 01                	push   $0x1
  d5:	e8 b6 03 00 00       	call   490 <printf>

    free(status);
  da:	89 1c 24             	mov    %ebx,(%esp)
  dd:	e8 7e 05 00 00       	call   660 <free>
    exit(0);
 ...
 661:	a1 30 0b 00 00       	mov    0xb30,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 30 0b 00 00       	mov    %eax,0xb30
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 30 0b 00 00    	cmp    %eax,0xb30
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 30 0b 00 00    	mov    0xb30,%edx
 ...
 7b7:	0b 00 00 
 7ba:	c7 05 34 0b 00 00 34 	movl   $0xb34,0xb34
 7c1:	0b 00 00 
    base.s.size = 0;
 7c4:	b8 34 0b 00 00       	mov    $0xb34,%eax
 7c9:	c7 05 38 0b 00 00 00 	movl   $0x0,0xb38
 7d0:	00 00 00 
