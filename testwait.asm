...
main(int argc, char *argv[])
{
  ...
  b3:	59                   	pop    %ecx
  b4:	58                   	pop    %eax
  b5:	68 3e 08 00 00       	push   $0x83e
  ba:	6a 01                	push   $0x1
  bc:	e8 ef 03 00 00       	call   4b0 <printf>
    wait(status);
  c1:	89 1c 24             	mov    %ebx,(%esp)
  c4:	e8 81 02 00 00       	call   34a <wait>
    printf(1,"done. status: %d\n", (*status));
  c9:	83 c4 0c             	add    $0xc,%esp
  cc:	ff 33                	pushl  (%ebx)
  ce:	68 2c 08 00 00       	push   $0x82c
  d3:	6a 01                	push   $0x1
  d5:	e8 d6 03 00 00       	call   4b0 <printf>

    free(status);
  da:	89 1c 24             	mov    %ebx,(%esp)
  dd:	e8 9e 05 00 00       	call   680 <free>
    exit(0);
  e2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  e9:	e8 54 02 00 00       	call   342 <exit>
  ee:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb a0 08 00 00       	mov    $0x8a0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 681:	a1 50 0b 00 00       	mov    0xb50,%eax
{
 ...
 6bd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6bf:	a3 50 0b 00 00       	mov    %eax,0xb50
}
 6c4:	5b                   	pop    %ebx
 6c5:	5e                   	pop    %esi
 6c6:	5f                   	pop    %edi
 ...
 6d6:	72 ce                	jb     6a6 <free+0x26>
{
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 50 0b 00 00       	mov    %eax,0xb50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 15 50 0b 00 00    	mov    0xb50,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 47                	jae    7a8 <malloc+0x98>
    ...
    if(p == freep)
 761:	39 05 50 0b 00 00    	cmp    %eax,0xb50
 ...
 786:	e8 f5 fe ff ff       	call   680 <free>
  return freep;
 78b:	8b 15 50 0b 00 00    	mov    0xb50,%edx
 ...
 7b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7b7:	89 15 50 0b 00 00    	mov    %edx,0xb50
}
 ...
 7c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 50 0b 00 00 54 	movl   $0xb54,0xb50
 7d7:	0b 00 00 
 7da:	c7 05 54 0b 00 00 54 	movl   $0xb54,0xb54
 7e1:	0b 00 00 
    base.s.size = 0;
 7e4:	b8 54 0b 00 00       	mov    $0xb54,%eax
 7e9:	c7 05 58 0b 00 00 00 	movl   $0x0,0xb58
 7f0:	00 00 00 
