...
main(int argc, char *argv[])
{
  ...
  24:	58                   	pop    %eax
  25:	5a                   	pop    %edx
  26:	68 c3 07 00 00       	push   $0x7c3
  2b:	6a 01                	push   $0x1
  2d:	e8 1e 04 00 00       	call   450 <printf>
    char* arr = malloc(2048);
  32:	c7 04 24 00 08 00 00 	movl   $0x800,(%esp)
  ...
  55:	59                   	pop    %ecx
  56:	58                   	pop    %eax
  57:	68 db 07 00 00       	push   $0x7db
  5c:	6a 01                	push   $0x1
  5e:	e8 ed 03 00 00       	call   450 <printf>
    free(arr);
  63:	89 1c 24             	mov    %ebx,(%esp)
  66:	e8 b5 05 00 00       	call   620 <free>
    memory = memsize();
