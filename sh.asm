...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      6b:	6a 64                	push   $0x64
      6d:	68 20 19 00 00       	push   $0x1920
      72:	e8 a9 00 00 00       	call   120 <getcmd>
      77:	83 c4 10             	add    $0x10,%esp
      7a:	85 c0                	test   %eax,%eax
      7c:	78 37                	js     b5 <main+0xb5>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      7e:	80 3d 20 19 00 00 63 	cmpb   $0x63,0x1920
      85:	75 c6                	jne    4d <main+0x4d>
      87:	80 3d 21 19 00 00 64 	cmpb   $0x64,0x1921
  ...
  exit(0);
      ...
      ff:	50                   	push   %eax
     100:	68 23 19 00 00       	push   $0x1923
     105:	68 f1 12 00 00       	push   $0x12f1
     10a:	6a 02                	push   $0x2
     10c:	e8 df 0d 00 00       	call   ef0 <printf>
...
00000120 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     12e:	68 48 12 00 00       	push   $0x1248
     133:	6a 02                	push   $0x2
     135:	e8 b6 0d 00 00       	call   ef0 <printf>
  memset(buf, 0, nbuf);
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 e5 12 00 00       	push   $0x12e5
     17e:	6a 02                	push   $0x2
     180:	e8 6b 0d 00 00       	call   ef0 <printf>
  exit(1);
...
000001a0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1bd:	ff 24 85 00 13 00 00 	jmp    *0x1300(,%eax,4)
    if(pipe(p) < 0)
  ...
  if(pid == -1)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     27a:	68 52 12 00 00       	push   $0x1252
     27f:	6a 02                	push   $0x2
     281:	e8 6a 0c 00 00       	call   ef0 <printf>
    exit(1); // new
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     2b5:	68 62 12 00 00       	push   $0x1262
     2ba:	6a 02                	push   $0x2
     2bc:	e8 2f 0c 00 00       	call   ef0 <printf>
      exit(1);
  ...
  if(pid == -1)
    ...
    panic("runcmd");
     ...
     2f5:	68 4b 12 00 00       	push   $0x124b
     2fa:	e8 71 fe ff ff       	call   170 <panic>
    panic("fork");
     2ff:	83 ec 0c             	sub    $0xc,%esp
     302:	68 72 12 00 00       	push   $0x1272
     ...
     33d:	68 77 12 00 00       	push   $0x1277
...
00000e42 <proc_info>:
SYSCALL(proc_info)
     e42:	b8 1a 00 00 00       	mov    $0x1a,%eax
     e47:	cd 40                	int    $0x40
     e49:	c3                   	ret    
