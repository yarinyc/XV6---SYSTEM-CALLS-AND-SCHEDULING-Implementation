...
80101ec8:	68 02 77 10 80       	push   $0x80107702
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 e7 56 10 80 	movl   $0x801056e7,0x14(%eax)
  p->context = (struct context*)sp;
...
80103c2a:	0f 84 f7 00 00 00    	je     80103d27 <exit+0x127>
    if(curproc->ofile[fd]){
...
80103c64:	8b 45 08             	mov    0x8(%ebp),%eax
  curproc->cwd = 0;
80103c67:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  curproc->exit_status = status; // update the exit status of the process
80103c6e:	89 46 7c             	mov    %eax,0x7c(%esi)
  acquire(&ptable.lock);
80103c71:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c78:	e8 f3 06 00 00       	call   80104370 <acquire>
  wakeup1(curproc->parent);
80103c7d:	8b 56 14             	mov    0x14(%esi),%edx
...
80103c88:	eb 10                	jmp    80103c9a <exit+0x9a>
80103c8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103c90:	83 e8 80             	sub    $0xffffff80,%eax
80103c93:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80103c98:	73 1c                	jae    80103cb6 <exit+0xb6>
    if(p->state == SLEEPING && p->chan == chan)
80103c9a:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103c9e:	75 f0                	jne    80103c90 <exit+0x90>
80103ca0:	3b 50 20             	cmp    0x20(%eax),%edx
80103ca3:	75 eb                	jne    80103c90 <exit+0x90>
      p->state = RUNNABLE;
80103ca5:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cac:	83 e8 80             	sub    $0xffffff80,%eax
80103caf:	3d 54 4d 11 80       	cmp    $0x80114d54,%eax
80103cb4:	72 e4                	jb     80103c9a <exit+0x9a>
      p->parent = initproc;
80103cb6:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cbc:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103cc1:	eb 10                	jmp    80103cd3 <exit+0xd3>
80103cc3:	90                   	nop
80103cc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103cc8:	83 ea 80             	sub    $0xffffff80,%edx
80103ccb:	81 fa 54 4d 11 80    	cmp    $0x80114d54,%edx
80103cd1:	73 3b                	jae    80103d0e <exit+0x10e>
    if(p->parent == curproc){
80103cd3:	39 72 14             	cmp    %esi,0x14(%edx)
80103cd6:	75 f0                	jne    80103cc8 <exit+0xc8>
      if(p->state == ZOMBIE)
80103cd8:	83 7a 0c 05          	cmpl   $0x5,0xc(%edx)
      p->parent = initproc;
80103cdc:	89 4a 14             	mov    %ecx,0x14(%edx)
      if(p->state == ZOMBIE)
80103cdf:	75 e7                	jne    80103cc8 <exit+0xc8>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ce1:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103ce6:	eb 12                	jmp    80103cfa <exit+0xfa>
80103ce8:	90                   	nop
...
80103cf8:	73 ce                	jae    80103cc8 <exit+0xc8>
    if(p->state == SLEEPING && p->chan == chan)
...
80103e59:	8b 7d 08             	mov    0x8(%ebp),%edi
  pushcli();
80103e5c:	e8 3f 04 00 00       	call   801042a0 <pushcli>
  c = mycpu();
80103e61:	e8 da f8 ff ff       	call   80103740 <mycpu>
  p = c->proc;
80103e66:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e6c:	e8 6f 04 00 00       	call   801042e0 <popcli>
  acquire(&ptable.lock);
80103e71:	83 ec 0c             	sub    $0xc,%esp
80103e74:	68 20 2d 11 80       	push   $0x80112d20
80103e79:	e8 f2 04 00 00       	call   80104370 <acquire>
80103e7e:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103e81:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e83:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103e88:	eb 11                	jmp    80103e9b <wait+0x4b>
80103e8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80103e90:	83 eb 80             	sub    $0xffffff80,%ebx
80103e93:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103e99:	73 1b                	jae    80103eb6 <wait+0x66>
      if(p->parent != curproc)
80103e9b:	39 73 14             	cmp    %esi,0x14(%ebx)
80103e9e:	75 f0                	jne    80103e90 <wait+0x40>
      if(p->state == ZOMBIE){
80103ea0:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103ea4:	74 3a                	je     80103ee0 <wait+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ea6:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
80103ea9:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103eae:	81 fb 54 4d 11 80    	cmp    $0x80114d54,%ebx
80103eb4:	72 e5                	jb     80103e9b <wait+0x4b>
    if(!havekids || curproc->killed){
80103eb6:	85 c0                	test   %eax,%eax
80103eb8:	0f 84 89 00 00 00    	je     80103f47 <wait+0xf7>
80103ebe:	8b 46 24             	mov    0x24(%esi),%eax
80103ec1:	85 c0                	test   %eax,%eax
80103ec3:	0f 85 7e 00 00 00    	jne    80103f47 <wait+0xf7>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103ec9:	83 ec 08             	sub    $0x8,%esp
80103ecc:	68 20 2d 11 80       	push   $0x80112d20
80103ed1:	56                   	push   %esi
80103ed2:	e8 b9 fe ff ff       	call   80103d90 <sleep>
    havekids = 0;
80103ed7:	83 c4 10             	add    $0x10,%esp
80103eda:	eb a5                	jmp    80103e81 <wait+0x31>
80103edc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        if(status!=null)
80103ee0:	85 ff                	test   %edi,%edi
80103ee2:	74 05                	je     80103ee9 <wait+0x99>
          *status = p->exit_status;
80103ee4:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103ee7:	89 07                	mov    %eax,(%edi)
        kfree(p->kstack);
80103ee9:	83 ec 0c             	sub    $0xc,%esp
80103eec:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
80103eef:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103ef2:	e8 19 e4 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
80103ef7:	5a                   	pop    %edx
80103ef8:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
80103efb:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f02:	e8 69 2d 00 00       	call   80106c70 <freevm>
        release(&ptable.lock);
80103f07:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
...
80103f20:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->exit_status = 0;
80103f27:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        p->state = UNUSED;
...
80103f47:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80103f4a:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f4f:	68 20 2d 11 80       	push   $0x80112d20
80103f54:	e8 d7 04 00 00       	call   80104430 <release>
      return -1;
80103f59:	83 c4 10             	add    $0x10,%esp
80103f5c:	eb df                	jmp    80103f3d <wait+0xed>
...
8010405b:	68 1b 79 10 80       	push   $0x8010791b
...
8010407e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104081:	ba a0 75 10 80       	mov    $0x801075a0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104086:	77 11                	ja     80104099 <procdump+0x59>
80104088:	8b 14 85 00 76 10 80 	mov    -0x7fef8a00(,%eax,4),%edx
      state = "???";
8010408f:	b8 a0 75 10 80       	mov    $0x801075a0,%eax
...
801040a1:	68 a4 75 10 80       	push   $0x801075a4
...
801040dd:	68 e1 6f 10 80       	push   $0x80106fe1
...
8010410a:	68 18 76 10 80       	push   $0x80107618
...
80104325:	68 23 76 10 80       	push   $0x80107623
8010432a:	e8 61 c0 ff ff       	call   80100390 <panic>
    panic("popcli");
8010432f:	83 ec 0c             	sub    $0xc,%esp
80104332:	68 3a 76 10 80       	push   $0x8010763a
...
80104417:	68 41 76 10 80       	push   $0x80107641
...
8010446c:	68 49 76 10 80       	push   $0x80107649
...
8010488c:	8b 14 85 80 76 10 80 	mov    -0x7fef8980(,%eax,4),%edx
...
801048b0:	68 51 76 10 80       	push   $0x80107651
...
80104a04:	68 f8 76 10 80       	push   $0x801076f8
...
80104a1c:	68 f7 76 10 80       	push   $0x801076f7
...
80104a35:	68 eb 76 10 80       	push   $0x801076eb
...
80104a4a:	68 fa 76 10 80       	push   $0x801076fa
80104a4f:	e8 3c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a54:	83 ec 0c             	sub    $0xc,%esp
80104a57:	68 dc 76 10 80       	push   $0x801076dc
...
80104e49:	58                   	pop    %eax
80104e4a:	5a                   	pop    %edx
80104e4b:	68 f8 76 10 80       	push   $0x801076f8
...
80104e64:	68 f7 76 10 80       	push   $0x801076f7
...
801054cc:	e8 af f2 ff ff       	call   80104780 <argint>
801054d1:	83 c4 10             	add    $0x10,%esp
801054d4:	85 c0                	test   %eax,%eax
801054d6:	78 18                	js     801054f0 <sys_exit+0x30>
    return -1;
  exit(status);
801054d8:	83 ec 0c             	sub    $0xc,%esp
801054db:	ff 75 f4             	pushl  -0xc(%ebp)
801054de:	e8 1d e7 ff ff       	call   80103c00 <exit>
  return 0;  // not reached
801054e3:	83 c4 10             	add    $0x10,%esp
801054e6:	31 c0                	xor    %eax,%eax
}
801054e8:	c9                   	leave  
801054e9:	c3                   	ret    
...
80105516:	78 18                	js     80105530 <sys_wait+0x30>
    return -1;
  return wait((int*)status);
80105518:	83 ec 0c             	sub    $0xc,%esp
8010551b:	ff 75 f4             	pushl  -0xc(%ebp)
8010551e:	e8 2d e9 ff ff       	call   80103e50 <wait>
...
8010554c:	e8 2f f2 ff ff       	call   80104780 <argint>
...
8010555e:	e8 5d ea ff ff       	call   80103fc0 <kill>
...
801055ed:	e8 8e f1 ff ff       	call   80104780 <argint>
...
80105605:	e8 66 ed ff ff       	call   80104370 <acquire>
  ticks0 = ticks;
...
8010569c:	e8 cf ec ff ff       	call   80104370 <acquire>
  xticks = ticks;
...
801056c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->sz;
801056c6:	e8 15 e1 ff ff       	call   801037e0 <myproc>
...
801056d0:	06                   	push   %es
  pushl %fs
801056d1:	0f a0                	push   %fs
  pushl %gs
801056d3:	0f a8                	push   %gs
  pushal
801056d5:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801056d6:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801056da:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801056dc:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801056de:	54                   	push   %esp
  call trap
801056df:	e8 cc 00 00 00       	call   801057b0 <trap>
  addl $4, %esp
801056e4:	83 c4 04             	add    $0x4,%esp
...
801056e7:	61                   	popa   
  popl %gs
801056e8:	0f a9                	pop    %gs
  popl %fs
801056ea:	0f a1                	pop    %fs
  popl %es
801056ec:	07                   	pop    %es
  popl %ds
801056ed:	1f                   	pop    %ds
...
80105717:	c7 04 c5 a2 4d 11 80 	movl   $0x8e000008,-0x7feeb25e(,%eax,8)
8010571e:	08 00 00 8e 
80105722:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105729:	80 
8010572a:	c1 ea 10             	shr    $0x10,%edx
8010572d:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
80105734:	80 
  for(i = 0; i < 256; i++)
...
80105744:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105747:	c7 05 a2 4f 11 80 08 	movl   $0xef000008,0x80114fa2
8010574e:	00 00 ef 
  initlock(&tickslock, "time");
80105751:	68 3d 77 10 80       	push   $0x8010773d
80105756:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010575b:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
80105761:	c1 e8 10             	shr    $0x10,%eax
80105764:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010576a:	e8 c1 ea ff ff       	call   80104230 <initlock>
}
...
801057e7:	8b 7b 38             	mov    0x38(%ebx),%edi
801057ea:	0f 84 44 02 00 00    	je     80105a34 <trap+0x284>
801057f0:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801057f4:	0f 84 3a 02 00 00    	je     80105a34 <trap+0x284>
...
80105808:	8b 43 34             	mov    0x34(%ebx),%eax
...
80105863:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105867:	83 e0 03             	and    $0x3,%eax
8010586a:	66 83 f8 03          	cmp    $0x3,%ax
8010586e:	0f 84 74 01 00 00    	je     801059e8 <trap+0x238>
    exit(0);
...
80105886:	74 78                	je     80105900 <trap+0x150>
...
801058b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    if(myproc()->killed)
801058c0:	e8 1b df ff ff       	call   801037e0 <myproc>
801058c5:	8b 70 24             	mov    0x24(%eax),%esi
801058c8:	85 f6                	test   %esi,%esi
801058ca:	0f 85 f0 00 00 00    	jne    801059c0 <trap+0x210>
    myproc()->tf = tf;
801058d0:	e8 0b df ff ff       	call   801037e0 <myproc>
801058d5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801058d8:	e8 93 ef ff ff       	call   80104870 <syscall>
    if(myproc()->killed)
801058dd:	e8 fe de ff ff       	call   801037e0 <myproc>
801058e2:	8b 48 24             	mov    0x24(%eax),%ecx
801058e5:	85 c9                	test   %ecx,%ecx
801058e7:	74 c5                	je     801058ae <trap+0xfe>
      exit(1);
801058e9:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
...
80105949:	0f 85 08 ff ff ff    	jne    80105857 <trap+0xa7>
8010594f:	e9 20 ff ff ff       	jmp    80105874 <trap+0xc4>
80105954:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105958:	e8 73 02 00 00       	call   80105bd0 <uartintr>
    lapiceoi();
8010595d:	e8 ee cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105962:	e8 79 de ff ff       	call   801037e0 <myproc>
80105967:	85 c0                	test   %eax,%eax
80105969:	0f 85 e8 fe ff ff    	jne    80105857 <trap+0xa7>
8010596f:	e9 00 ff ff ff       	jmp    80105874 <trap+0xc4>
80105974:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105978:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
8010597c:	8b 7b 38             	mov    0x38(%ebx),%edi
8010597f:	e8 3c de ff ff       	call   801037c0 <cpuid>
...
80105a42:	ff 73 30             	pushl  0x30(%ebx)
80105a45:	68 6c 77 10 80       	push   $0x8010776c
80105a4a:	e8 11 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a4f:	83 c4 14             	add    $0x14,%esp
80105a52:	68 42 77 10 80       	push   $0x80107742
...
80105b4c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b4f:	bb 64 78 10 80       	mov    $0x80107864,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105be7:	6a 00                	push   $0x0
  jmp alltraps
80105be9:	e9 e1 fa ff ff       	jmp    801056cf <alltraps>
...
80105bf0:	6a 01                	push   $0x1
  jmp alltraps
80105bf2:	e9 d8 fa ff ff       	jmp    801056cf <alltraps>
...
80105bf9:	6a 02                	push   $0x2
  jmp alltraps
80105bfb:	e9 cf fa ff ff       	jmp    801056cf <alltraps>
...
80105c02:	6a 03                	push   $0x3
  jmp alltraps
80105c04:	e9 c6 fa ff ff       	jmp    801056cf <alltraps>
...
80105c0b:	6a 04                	push   $0x4
  jmp alltraps
80105c0d:	e9 bd fa ff ff       	jmp    801056cf <alltraps>
...
80105c14:	6a 05                	push   $0x5
  jmp alltraps
80105c16:	e9 b4 fa ff ff       	jmp    801056cf <alltraps>
...
80105c1d:	6a 06                	push   $0x6
  jmp alltraps
80105c1f:	e9 ab fa ff ff       	jmp    801056cf <alltraps>
...
80105c26:	6a 07                	push   $0x7
  jmp alltraps
80105c28:	e9 a2 fa ff ff       	jmp    801056cf <alltraps>
...
80105c2d:	6a 08                	push   $0x8
  jmp alltraps
80105c2f:	e9 9b fa ff ff       	jmp    801056cf <alltraps>
...
80105c36:	6a 09                	push   $0x9
  jmp alltraps
80105c38:	e9 92 fa ff ff       	jmp    801056cf <alltraps>
...
80105c3d:	6a 0a                	push   $0xa
  jmp alltraps
80105c3f:	e9 8b fa ff ff       	jmp    801056cf <alltraps>
...
80105c44:	6a 0b                	push   $0xb
  jmp alltraps
80105c46:	e9 84 fa ff ff       	jmp    801056cf <alltraps>
...
80105c4b:	6a 0c                	push   $0xc
  jmp alltraps
80105c4d:	e9 7d fa ff ff       	jmp    801056cf <alltraps>
...
80105c52:	6a 0d                	push   $0xd
  jmp alltraps
80105c54:	e9 76 fa ff ff       	jmp    801056cf <alltraps>
...
80105c59:	6a 0e                	push   $0xe
  jmp alltraps
80105c5b:	e9 6f fa ff ff       	jmp    801056cf <alltraps>
...
80105c62:	6a 0f                	push   $0xf
  jmp alltraps
80105c64:	e9 66 fa ff ff       	jmp    801056cf <alltraps>
...
80105c6b:	6a 10                	push   $0x10
  jmp alltraps
80105c6d:	e9 5d fa ff ff       	jmp    801056cf <alltraps>
...
80105c72:	6a 11                	push   $0x11
  jmp alltraps
80105c74:	e9 56 fa ff ff       	jmp    801056cf <alltraps>
...
80105c7b:	6a 12                	push   $0x12
  jmp alltraps
80105c7d:	e9 4d fa ff ff       	jmp    801056cf <alltraps>
...
80105c84:	6a 13                	push   $0x13
  jmp alltraps
80105c86:	e9 44 fa ff ff       	jmp    801056cf <alltraps>
...
80105c8d:	6a 14                	push   $0x14
  jmp alltraps
80105c8f:	e9 3b fa ff ff       	jmp    801056cf <alltraps>
...
80105c96:	6a 15                	push   $0x15
  jmp alltraps
80105c98:	e9 32 fa ff ff       	jmp    801056cf <alltraps>
...
80105c9f:	6a 16                	push   $0x16
  jmp alltraps
80105ca1:	e9 29 fa ff ff       	jmp    801056cf <alltraps>
...
80105ca8:	6a 17                	push   $0x17
  jmp alltraps
80105caa:	e9 20 fa ff ff       	jmp    801056cf <alltraps>
...
80105cb1:	6a 18                	push   $0x18
  jmp alltraps
80105cb3:	e9 17 fa ff ff       	jmp    801056cf <alltraps>
...
80105cba:	6a 19                	push   $0x19
  jmp alltraps
80105cbc:	e9 0e fa ff ff       	jmp    801056cf <alltraps>
...
80105cc3:	6a 1a                	push   $0x1a
  jmp alltraps
80105cc5:	e9 05 fa ff ff       	jmp    801056cf <alltraps>
...
80105ccc:	6a 1b                	push   $0x1b
  jmp alltraps
80105cce:	e9 fc f9 ff ff       	jmp    801056cf <alltraps>
...
80105cd5:	6a 1c                	push   $0x1c
  jmp alltraps
80105cd7:	e9 f3 f9 ff ff       	jmp    801056cf <alltraps>
...
80105cde:	6a 1d                	push   $0x1d
  jmp alltraps
80105ce0:	e9 ea f9 ff ff       	jmp    801056cf <alltraps>
...
80105ce7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ce9:	e9 e1 f9 ff ff       	jmp    801056cf <alltraps>
...
80105cf0:	6a 1f                	push   $0x1f
  jmp alltraps
80105cf2:	e9 d8 f9 ff ff       	jmp    801056cf <alltraps>
...
80105cf9:	6a 20                	push   $0x20
  jmp alltraps
80105cfb:	e9 cf f9 ff ff       	jmp    801056cf <alltraps>
...
80105d02:	6a 21                	push   $0x21
  jmp alltraps
80105d04:	e9 c6 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d0b:	6a 22                	push   $0x22
  jmp alltraps
80105d0d:	e9 bd f9 ff ff       	jmp    801056cf <alltraps>
...
80105d14:	6a 23                	push   $0x23
  jmp alltraps
80105d16:	e9 b4 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d1d:	6a 24                	push   $0x24
  jmp alltraps
80105d1f:	e9 ab f9 ff ff       	jmp    801056cf <alltraps>
...
80105d26:	6a 25                	push   $0x25
  jmp alltraps
80105d28:	e9 a2 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d2f:	6a 26                	push   $0x26
  jmp alltraps
80105d31:	e9 99 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d38:	6a 27                	push   $0x27
  jmp alltraps
80105d3a:	e9 90 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d41:	6a 28                	push   $0x28
  jmp alltraps
80105d43:	e9 87 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d4a:	6a 29                	push   $0x29
  jmp alltraps
80105d4c:	e9 7e f9 ff ff       	jmp    801056cf <alltraps>
...
80105d53:	6a 2a                	push   $0x2a
  jmp alltraps
80105d55:	e9 75 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d5c:	6a 2b                	push   $0x2b
  jmp alltraps
80105d5e:	e9 6c f9 ff ff       	jmp    801056cf <alltraps>
...
80105d65:	6a 2c                	push   $0x2c
  jmp alltraps
80105d67:	e9 63 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d6e:	6a 2d                	push   $0x2d
  jmp alltraps
80105d70:	e9 5a f9 ff ff       	jmp    801056cf <alltraps>
...
80105d77:	6a 2e                	push   $0x2e
  jmp alltraps
80105d79:	e9 51 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d80:	6a 2f                	push   $0x2f
  jmp alltraps
80105d82:	e9 48 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d89:	6a 30                	push   $0x30
  jmp alltraps
80105d8b:	e9 3f f9 ff ff       	jmp    801056cf <alltraps>
...
80105d92:	6a 31                	push   $0x31
  jmp alltraps
80105d94:	e9 36 f9 ff ff       	jmp    801056cf <alltraps>
...
80105d9b:	6a 32                	push   $0x32
  jmp alltraps
80105d9d:	e9 2d f9 ff ff       	jmp    801056cf <alltraps>
...
80105da4:	6a 33                	push   $0x33
  jmp alltraps
80105da6:	e9 24 f9 ff ff       	jmp    801056cf <alltraps>
...
80105dad:	6a 34                	push   $0x34
  jmp alltraps
80105daf:	e9 1b f9 ff ff       	jmp    801056cf <alltraps>
...
80105db6:	6a 35                	push   $0x35
  jmp alltraps
80105db8:	e9 12 f9 ff ff       	jmp    801056cf <alltraps>
...
80105dbf:	6a 36                	push   $0x36
  jmp alltraps
80105dc1:	e9 09 f9 ff ff       	jmp    801056cf <alltraps>
...
80105dc8:	6a 37                	push   $0x37
  jmp alltraps
80105dca:	e9 00 f9 ff ff       	jmp    801056cf <alltraps>
...
80105dd1:	6a 38                	push   $0x38
  jmp alltraps
80105dd3:	e9 f7 f8 ff ff       	jmp    801056cf <alltraps>
...
80105dda:	6a 39                	push   $0x39
  jmp alltraps
80105ddc:	e9 ee f8 ff ff       	jmp    801056cf <alltraps>
...
80105de3:	6a 3a                	push   $0x3a
  jmp alltraps
80105de5:	e9 e5 f8 ff ff       	jmp    801056cf <alltraps>
...
80105dec:	6a 3b                	push   $0x3b
  jmp alltraps
80105dee:	e9 dc f8 ff ff       	jmp    801056cf <alltraps>
...
80105df5:	6a 3c                	push   $0x3c
  jmp alltraps
80105df7:	e9 d3 f8 ff ff       	jmp    801056cf <alltraps>
...
80105dfe:	6a 3d                	push   $0x3d
  jmp alltraps
80105e00:	e9 ca f8 ff ff       	jmp    801056cf <alltraps>
...
80105e07:	6a 3e                	push   $0x3e
  jmp alltraps
80105e09:	e9 c1 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e10:	6a 3f                	push   $0x3f
  jmp alltraps
80105e12:	e9 b8 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e19:	6a 40                	push   $0x40
  jmp alltraps
80105e1b:	e9 af f8 ff ff       	jmp    801056cf <alltraps>
...
80105e22:	6a 41                	push   $0x41
  jmp alltraps
80105e24:	e9 a6 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e2b:	6a 42                	push   $0x42
  jmp alltraps
80105e2d:	e9 9d f8 ff ff       	jmp    801056cf <alltraps>
...
80105e34:	6a 43                	push   $0x43
  jmp alltraps
80105e36:	e9 94 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e3d:	6a 44                	push   $0x44
  jmp alltraps
80105e3f:	e9 8b f8 ff ff       	jmp    801056cf <alltraps>
...
80105e46:	6a 45                	push   $0x45
  jmp alltraps
80105e48:	e9 82 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e4f:	6a 46                	push   $0x46
  jmp alltraps
80105e51:	e9 79 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e58:	6a 47                	push   $0x47
  jmp alltraps
80105e5a:	e9 70 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e61:	6a 48                	push   $0x48
  jmp alltraps
80105e63:	e9 67 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e6a:	6a 49                	push   $0x49
  jmp alltraps
80105e6c:	e9 5e f8 ff ff       	jmp    801056cf <alltraps>
...
80105e73:	6a 4a                	push   $0x4a
  jmp alltraps
80105e75:	e9 55 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e7c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e7e:	e9 4c f8 ff ff       	jmp    801056cf <alltraps>
...
80105e85:	6a 4c                	push   $0x4c
  jmp alltraps
80105e87:	e9 43 f8 ff ff       	jmp    801056cf <alltraps>
...
80105e8e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e90:	e9 3a f8 ff ff       	jmp    801056cf <alltraps>
...
80105e97:	6a 4e                	push   $0x4e
  jmp alltraps
80105e99:	e9 31 f8 ff ff       	jmp    801056cf <alltraps>
...
80105ea0:	6a 4f                	push   $0x4f
  jmp alltraps
80105ea2:	e9 28 f8 ff ff       	jmp    801056cf <alltraps>
...
80105ea9:	6a 50                	push   $0x50
  jmp alltraps
80105eab:	e9 1f f8 ff ff       	jmp    801056cf <alltraps>
...
80105eb2:	6a 51                	push   $0x51
  jmp alltraps
80105eb4:	e9 16 f8 ff ff       	jmp    801056cf <alltraps>
...
80105ebb:	6a 52                	push   $0x52
  jmp alltraps
80105ebd:	e9 0d f8 ff ff       	jmp    801056cf <alltraps>
...
80105ec4:	6a 53                	push   $0x53
  jmp alltraps
80105ec6:	e9 04 f8 ff ff       	jmp    801056cf <alltraps>
...
80105ecd:	6a 54                	push   $0x54
  jmp alltraps
80105ecf:	e9 fb f7 ff ff       	jmp    801056cf <alltraps>
...
80105ed6:	6a 55                	push   $0x55
  jmp alltraps
80105ed8:	e9 f2 f7 ff ff       	jmp    801056cf <alltraps>
...
80105edf:	6a 56                	push   $0x56
  jmp alltraps
80105ee1:	e9 e9 f7 ff ff       	jmp    801056cf <alltraps>
...
80105ee8:	6a 57                	push   $0x57
  jmp alltraps
80105eea:	e9 e0 f7 ff ff       	jmp    801056cf <alltraps>
...
80105ef1:	6a 58                	push   $0x58
  jmp alltraps
80105ef3:	e9 d7 f7 ff ff       	jmp    801056cf <alltraps>
...
80105efa:	6a 59                	push   $0x59
  jmp alltraps
80105efc:	e9 ce f7 ff ff       	jmp    801056cf <alltraps>
...
80105f03:	6a 5a                	push   $0x5a
  jmp alltraps
80105f05:	e9 c5 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f0c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f0e:	e9 bc f7 ff ff       	jmp    801056cf <alltraps>
...
80105f15:	6a 5c                	push   $0x5c
  jmp alltraps
80105f17:	e9 b3 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f1e:	6a 5d                	push   $0x5d
  jmp alltraps
80105f20:	e9 aa f7 ff ff       	jmp    801056cf <alltraps>
...
80105f27:	6a 5e                	push   $0x5e
  jmp alltraps
80105f29:	e9 a1 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f30:	6a 5f                	push   $0x5f
  jmp alltraps
80105f32:	e9 98 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f39:	6a 60                	push   $0x60
  jmp alltraps
80105f3b:	e9 8f f7 ff ff       	jmp    801056cf <alltraps>
...
80105f42:	6a 61                	push   $0x61
  jmp alltraps
80105f44:	e9 86 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f4b:	6a 62                	push   $0x62
  jmp alltraps
80105f4d:	e9 7d f7 ff ff       	jmp    801056cf <alltraps>
...
80105f54:	6a 63                	push   $0x63
  jmp alltraps
80105f56:	e9 74 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f5d:	6a 64                	push   $0x64
  jmp alltraps
80105f5f:	e9 6b f7 ff ff       	jmp    801056cf <alltraps>
...
80105f66:	6a 65                	push   $0x65
  jmp alltraps
80105f68:	e9 62 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f6f:	6a 66                	push   $0x66
  jmp alltraps
80105f71:	e9 59 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f78:	6a 67                	push   $0x67
  jmp alltraps
80105f7a:	e9 50 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f81:	6a 68                	push   $0x68
  jmp alltraps
80105f83:	e9 47 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f8a:	6a 69                	push   $0x69
  jmp alltraps
80105f8c:	e9 3e f7 ff ff       	jmp    801056cf <alltraps>
...
80105f93:	6a 6a                	push   $0x6a
  jmp alltraps
80105f95:	e9 35 f7 ff ff       	jmp    801056cf <alltraps>
...
80105f9c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f9e:	e9 2c f7 ff ff       	jmp    801056cf <alltraps>
...
80105fa5:	6a 6c                	push   $0x6c
  jmp alltraps
80105fa7:	e9 23 f7 ff ff       	jmp    801056cf <alltraps>
...
80105fae:	6a 6d                	push   $0x6d
  jmp alltraps
80105fb0:	e9 1a f7 ff ff       	jmp    801056cf <alltraps>
...
80105fb7:	6a 6e                	push   $0x6e
  jmp alltraps
80105fb9:	e9 11 f7 ff ff       	jmp    801056cf <alltraps>
...
80105fc0:	6a 6f                	push   $0x6f
  jmp alltraps
80105fc2:	e9 08 f7 ff ff       	jmp    801056cf <alltraps>
...
80105fc9:	6a 70                	push   $0x70
  jmp alltraps
80105fcb:	e9 ff f6 ff ff       	jmp    801056cf <alltraps>
...
80105fd2:	6a 71                	push   $0x71
  jmp alltraps
80105fd4:	e9 f6 f6 ff ff       	jmp    801056cf <alltraps>
...
80105fdb:	6a 72                	push   $0x72
  jmp alltraps
80105fdd:	e9 ed f6 ff ff       	jmp    801056cf <alltraps>
...
80105fe4:	6a 73                	push   $0x73
  jmp alltraps
80105fe6:	e9 e4 f6 ff ff       	jmp    801056cf <alltraps>
...
80105fed:	6a 74                	push   $0x74
  jmp alltraps
80105fef:	e9 db f6 ff ff       	jmp    801056cf <alltraps>
...
80105ff6:	6a 75                	push   $0x75
  jmp alltraps
80105ff8:	e9 d2 f6 ff ff       	jmp    801056cf <alltraps>
...
80105fff:	6a 76                	push   $0x76
  jmp alltraps
80106001:	e9 c9 f6 ff ff       	jmp    801056cf <alltraps>
...
80106008:	6a 77                	push   $0x77
  jmp alltraps
8010600a:	e9 c0 f6 ff ff       	jmp    801056cf <alltraps>
...
80106011:	6a 78                	push   $0x78
  jmp alltraps
80106013:	e9 b7 f6 ff ff       	jmp    801056cf <alltraps>
...
8010601a:	6a 79                	push   $0x79
  jmp alltraps
8010601c:	e9 ae f6 ff ff       	jmp    801056cf <alltraps>
...
80106023:	6a 7a                	push   $0x7a
  jmp alltraps
80106025:	e9 a5 f6 ff ff       	jmp    801056cf <alltraps>
...
8010602c:	6a 7b                	push   $0x7b
  jmp alltraps
8010602e:	e9 9c f6 ff ff       	jmp    801056cf <alltraps>
...
80106035:	6a 7c                	push   $0x7c
  jmp alltraps
80106037:	e9 93 f6 ff ff       	jmp    801056cf <alltraps>
...
8010603e:	6a 7d                	push   $0x7d
  jmp alltraps
80106040:	e9 8a f6 ff ff       	jmp    801056cf <alltraps>
...
80106047:	6a 7e                	push   $0x7e
  jmp alltraps
80106049:	e9 81 f6 ff ff       	jmp    801056cf <alltraps>
...
80106050:	6a 7f                	push   $0x7f
  jmp alltraps
80106052:	e9 78 f6 ff ff       	jmp    801056cf <alltraps>
...
80106059:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010605e:	e9 6c f6 ff ff       	jmp    801056cf <alltraps>
...
80106065:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010606a:	e9 60 f6 ff ff       	jmp    801056cf <alltraps>
...
80106071:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106076:	e9 54 f6 ff ff       	jmp    801056cf <alltraps>
...
8010607d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106082:	e9 48 f6 ff ff       	jmp    801056cf <alltraps>
...
80106089:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010608e:	e9 3c f6 ff ff       	jmp    801056cf <alltraps>
...
80106095:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010609a:	e9 30 f6 ff ff       	jmp    801056cf <alltraps>
...
801060a1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801060a6:	e9 24 f6 ff ff       	jmp    801056cf <alltraps>
...
801060ad:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801060b2:	e9 18 f6 ff ff       	jmp    801056cf <alltraps>
...
801060b9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801060be:	e9 0c f6 ff ff       	jmp    801056cf <alltraps>
...
801060c5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801060ca:	e9 00 f6 ff ff       	jmp    801056cf <alltraps>
...
801060d1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801060d6:	e9 f4 f5 ff ff       	jmp    801056cf <alltraps>
...
801060dd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801060e2:	e9 e8 f5 ff ff       	jmp    801056cf <alltraps>
...
801060e9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801060ee:	e9 dc f5 ff ff       	jmp    801056cf <alltraps>
...
801060f5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801060fa:	e9 d0 f5 ff ff       	jmp    801056cf <alltraps>
...
80106101:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106106:	e9 c4 f5 ff ff       	jmp    801056cf <alltraps>
...
8010610d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106112:	e9 b8 f5 ff ff       	jmp    801056cf <alltraps>
...
80106119:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010611e:	e9 ac f5 ff ff       	jmp    801056cf <alltraps>
...
80106125:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010612a:	e9 a0 f5 ff ff       	jmp    801056cf <alltraps>
...
80106131:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106136:	e9 94 f5 ff ff       	jmp    801056cf <alltraps>
...
8010613d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106142:	e9 88 f5 ff ff       	jmp    801056cf <alltraps>
...
80106149:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010614e:	e9 7c f5 ff ff       	jmp    801056cf <alltraps>
...
80106155:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010615a:	e9 70 f5 ff ff       	jmp    801056cf <alltraps>
...
80106161:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106166:	e9 64 f5 ff ff       	jmp    801056cf <alltraps>
...
8010616d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106172:	e9 58 f5 ff ff       	jmp    801056cf <alltraps>
...
80106179:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010617e:	e9 4c f5 ff ff       	jmp    801056cf <alltraps>
...
80106185:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010618a:	e9 40 f5 ff ff       	jmp    801056cf <alltraps>
...
80106191:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106196:	e9 34 f5 ff ff       	jmp    801056cf <alltraps>
...
8010619d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801061a2:	e9 28 f5 ff ff       	jmp    801056cf <alltraps>
...
801061a9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801061ae:	e9 1c f5 ff ff       	jmp    801056cf <alltraps>
...
801061b5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801061ba:	e9 10 f5 ff ff       	jmp    801056cf <alltraps>
...
801061c1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801061c6:	e9 04 f5 ff ff       	jmp    801056cf <alltraps>
...
801061cd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801061d2:	e9 f8 f4 ff ff       	jmp    801056cf <alltraps>
...
801061d9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801061de:	e9 ec f4 ff ff       	jmp    801056cf <alltraps>
...
801061e5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801061ea:	e9 e0 f4 ff ff       	jmp    801056cf <alltraps>
...
801061f1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801061f6:	e9 d4 f4 ff ff       	jmp    801056cf <alltraps>
...
801061fd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106202:	e9 c8 f4 ff ff       	jmp    801056cf <alltraps>
...
80106209:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010620e:	e9 bc f4 ff ff       	jmp    801056cf <alltraps>
...
80106215:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010621a:	e9 b0 f4 ff ff       	jmp    801056cf <alltraps>
...
80106221:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106226:	e9 a4 f4 ff ff       	jmp    801056cf <alltraps>
...
8010622d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106232:	e9 98 f4 ff ff       	jmp    801056cf <alltraps>
...
80106239:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010623e:	e9 8c f4 ff ff       	jmp    801056cf <alltraps>
...
80106245:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010624a:	e9 80 f4 ff ff       	jmp    801056cf <alltraps>
...
80106251:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106256:	e9 74 f4 ff ff       	jmp    801056cf <alltraps>
...
8010625d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106262:	e9 68 f4 ff ff       	jmp    801056cf <alltraps>
...
80106269:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010626e:	e9 5c f4 ff ff       	jmp    801056cf <alltraps>
...
80106275:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010627a:	e9 50 f4 ff ff       	jmp    801056cf <alltraps>
...
80106281:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106286:	e9 44 f4 ff ff       	jmp    801056cf <alltraps>
...
8010628d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106292:	e9 38 f4 ff ff       	jmp    801056cf <alltraps>
...
80106299:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010629e:	e9 2c f4 ff ff       	jmp    801056cf <alltraps>
...
801062a5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801062aa:	e9 20 f4 ff ff       	jmp    801056cf <alltraps>
...
801062b1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801062b6:	e9 14 f4 ff ff       	jmp    801056cf <alltraps>
...
801062bd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801062c2:	e9 08 f4 ff ff       	jmp    801056cf <alltraps>
...
801062c9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801062ce:	e9 fc f3 ff ff       	jmp    801056cf <alltraps>
...
801062d5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801062da:	e9 f0 f3 ff ff       	jmp    801056cf <alltraps>
...
801062e1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801062e6:	e9 e4 f3 ff ff       	jmp    801056cf <alltraps>
...
801062ed:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801062f2:	e9 d8 f3 ff ff       	jmp    801056cf <alltraps>
...
801062f9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801062fe:	e9 cc f3 ff ff       	jmp    801056cf <alltraps>
...
80106305:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010630a:	e9 c0 f3 ff ff       	jmp    801056cf <alltraps>
...
80106311:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106316:	e9 b4 f3 ff ff       	jmp    801056cf <alltraps>
...
8010631d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106322:	e9 a8 f3 ff ff       	jmp    801056cf <alltraps>
...
80106329:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010632e:	e9 9c f3 ff ff       	jmp    801056cf <alltraps>
...
80106335:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010633a:	e9 90 f3 ff ff       	jmp    801056cf <alltraps>
...
80106341:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106346:	e9 84 f3 ff ff       	jmp    801056cf <alltraps>
...
8010634d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106352:	e9 78 f3 ff ff       	jmp    801056cf <alltraps>
...
80106359:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010635e:	e9 6c f3 ff ff       	jmp    801056cf <alltraps>
...
80106365:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010636a:	e9 60 f3 ff ff       	jmp    801056cf <alltraps>
...
80106371:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106376:	e9 54 f3 ff ff       	jmp    801056cf <alltraps>
...
8010637d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106382:	e9 48 f3 ff ff       	jmp    801056cf <alltraps>
...
80106389:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010638e:	e9 3c f3 ff ff       	jmp    801056cf <alltraps>
...
80106395:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010639a:	e9 30 f3 ff ff       	jmp    801056cf <alltraps>
...
801063a1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801063a6:	e9 24 f3 ff ff       	jmp    801056cf <alltraps>
...
801063ad:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801063b2:	e9 18 f3 ff ff       	jmp    801056cf <alltraps>
...
801063b9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801063be:	e9 0c f3 ff ff       	jmp    801056cf <alltraps>
...
801063c5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801063ca:	e9 00 f3 ff ff       	jmp    801056cf <alltraps>
...
801063d1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801063d6:	e9 f4 f2 ff ff       	jmp    801056cf <alltraps>
...
801063dd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801063e2:	e9 e8 f2 ff ff       	jmp    801056cf <alltraps>
...
801063e9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801063ee:	e9 dc f2 ff ff       	jmp    801056cf <alltraps>
...
801063f5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801063fa:	e9 d0 f2 ff ff       	jmp    801056cf <alltraps>
...
80106401:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106406:	e9 c4 f2 ff ff       	jmp    801056cf <alltraps>
...
8010640d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106412:	e9 b8 f2 ff ff       	jmp    801056cf <alltraps>
...
80106419:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010641e:	e9 ac f2 ff ff       	jmp    801056cf <alltraps>
...
80106425:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010642a:	e9 a0 f2 ff ff       	jmp    801056cf <alltraps>
...
80106431:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106436:	e9 94 f2 ff ff       	jmp    801056cf <alltraps>
...
8010643d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106442:	e9 88 f2 ff ff       	jmp    801056cf <alltraps>
...
80106449:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010644e:	e9 7c f2 ff ff       	jmp    801056cf <alltraps>
...
80106455:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010645a:	e9 70 f2 ff ff       	jmp    801056cf <alltraps>
...
80106461:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106466:	e9 64 f2 ff ff       	jmp    801056cf <alltraps>
...
8010646d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106472:	e9 58 f2 ff ff       	jmp    801056cf <alltraps>
...
80106479:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010647e:	e9 4c f2 ff ff       	jmp    801056cf <alltraps>
...
80106485:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010648a:	e9 40 f2 ff ff       	jmp    801056cf <alltraps>
...
80106491:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106496:	e9 34 f2 ff ff       	jmp    801056cf <alltraps>
...
8010649d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801064a2:	e9 28 f2 ff ff       	jmp    801056cf <alltraps>
...
801064a9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801064ae:	e9 1c f2 ff ff       	jmp    801056cf <alltraps>
...
801064b5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801064ba:	e9 10 f2 ff ff       	jmp    801056cf <alltraps>
...
801064c1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801064c6:	e9 04 f2 ff ff       	jmp    801056cf <alltraps>
...
801064cd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801064d2:	e9 f8 f1 ff ff       	jmp    801056cf <alltraps>
...
801064d9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801064de:	e9 ec f1 ff ff       	jmp    801056cf <alltraps>
...
801064e5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801064ea:	e9 e0 f1 ff ff       	jmp    801056cf <alltraps>
...
801064f1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801064f6:	e9 d4 f1 ff ff       	jmp    801056cf <alltraps>
...
801064fd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106502:	e9 c8 f1 ff ff       	jmp    801056cf <alltraps>
...
80106509:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010650e:	e9 bc f1 ff ff       	jmp    801056cf <alltraps>
...
80106515:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010651a:	e9 b0 f1 ff ff       	jmp    801056cf <alltraps>
...
80106521:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106526:	e9 a4 f1 ff ff       	jmp    801056cf <alltraps>
...
8010652d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106532:	e9 98 f1 ff ff       	jmp    801056cf <alltraps>
...
80106539:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010653e:	e9 8c f1 ff ff       	jmp    801056cf <alltraps>
...
80106545:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010654a:	e9 80 f1 ff ff       	jmp    801056cf <alltraps>
...
80106551:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106556:	e9 74 f1 ff ff       	jmp    801056cf <alltraps>
...
8010655d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106562:	e9 68 f1 ff ff       	jmp    801056cf <alltraps>
...
80106569:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010656e:	e9 5c f1 ff ff       	jmp    801056cf <alltraps>
...
80106575:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010657a:	e9 50 f1 ff ff       	jmp    801056cf <alltraps>
...
80106581:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106586:	e9 44 f1 ff ff       	jmp    801056cf <alltraps>
...
8010658d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106592:	e9 38 f1 ff ff       	jmp    801056cf <alltraps>
...
80106599:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010659e:	e9 2c f1 ff ff       	jmp    801056cf <alltraps>
...
801065a5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801065aa:	e9 20 f1 ff ff       	jmp    801056cf <alltraps>
...
801065b1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801065b6:	e9 14 f1 ff ff       	jmp    801056cf <alltraps>
...
801065bd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801065c2:	e9 08 f1 ff ff       	jmp    801056cf <alltraps>
...
801065c9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801065ce:	e9 fc f0 ff ff       	jmp    801056cf <alltraps>
...
801065d5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801065da:	e9 f0 f0 ff ff       	jmp    801056cf <alltraps>
...
801065e1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801065e6:	e9 e4 f0 ff ff       	jmp    801056cf <alltraps>
...
801065ed:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801065f2:	e9 d8 f0 ff ff       	jmp    801056cf <alltraps>
...
801065f9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801065fe:	e9 cc f0 ff ff       	jmp    801056cf <alltraps>
...
80106605:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010660a:	e9 c0 f0 ff ff       	jmp    801056cf <alltraps>
...
80106611:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106616:	e9 b4 f0 ff ff       	jmp    801056cf <alltraps>
...
8010661d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106622:	e9 a8 f0 ff ff       	jmp    801056cf <alltraps>
...
80106629:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010662e:	e9 9c f0 ff ff       	jmp    801056cf <alltraps>
...
80106635:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010663a:	e9 90 f0 ff ff       	jmp    801056cf <alltraps>
...
80106641:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106646:	e9 84 f0 ff ff       	jmp    801056cf <alltraps>
...
8010664d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106652:	e9 78 f0 ff ff       	jmp    801056cf <alltraps>
...
801066ba:	e8 c1 dd ff ff       	call   80104480 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010675d:	68 6c 78 10 80       	push   $0x8010786c
...
801068e4:	0f 84 c2 00 00 00    	je     801069ac <switchuvm+0xec>
  pushcli();
801068ea:	e8 b1 d9 ff ff       	call   801042a0 <pushcli>
...
801069ff:	e8 7c da ff ff       	call   80104480 <memset>
...
80106a30:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106a31:	e9 fa da ff ff       	jmp    80104530 <memmove>
...
80106b5b:	e8 20 d9 ff ff       	call   80104480 <memset>
...
80106b9d:	68 e9 78 10 80       	push   $0x801078e9
...
80106bd3:	68 01 79 10 80       	push   $0x80107901
...
80106cdc:	68 1d 79 10 80       	push   $0x8010791d
...
80106d10:	e8 6b d7 ff ff       	call   80104480 <memset>
...
80106daf:	68 2e 79 10 80       	push   $0x8010792e
...
80106e00:	e8 2b d7 ff ff       	call   80104530 <memmove>
...
80106e99:	68 52 79 10 80       	push   $0x80107952
80106e9e:	e8 ed 94 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106ea3:	83 ec 0c             	sub    $0xc,%esp
80106ea6:	68 38 79 10 80       	push   $0x80107938
...
80106f2f:	e8 fc d5 ff ff       	call   80104530 <memmove>
    len -= n;
    buf += n;
